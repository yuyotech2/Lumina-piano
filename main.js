...
class LuminaPiano {
    ...
    async initAudio() {
        ...
        // Load multi-instrument sounds
        this.instruments = {
            // Piano: High-quality samples
            ...
            // E-Piano: Synthetic FM-style for 100% reliability (no downloads)
            epiano: new Tone.PolySynth(Tone.Synth, {
                oscillator: { type: "sine" },
                envelope: { attack: 0.01, decay: 0.5, sustain: 0.2, release: 1 },
                volume: -8
            }).connect(this.reverb),

            // Synth: Fat 80s sawtooth
            ...
            // Organ: Harmonic synthesis (no downloads needed)
            organ: new Tone.PolySynth(Tone.Synth, {
                oscillator: {
                    type: "fatcustom",
                    partials: [1, 0.5, 0.4, 0.3, 0.2, 0.1],
                    spread: 15
                },
